...
V1 = eig(AAt);
V1 = sort(V1, 'descend');
err1 = abs(V1(1) - lambda1)/abs(V1(1));
...
V2 = eig(AtA);
V2 = sort(V2, 'descend');
err2 = abs(V2(1) - lambda2)/abs(V2(1));
...
fprintf('Différence de temps entre méthode eig et puissance itérée = %0.3e\n', t/t_v2);
