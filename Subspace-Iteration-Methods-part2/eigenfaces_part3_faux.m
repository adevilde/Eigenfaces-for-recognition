...
[ W, V_2, n_ev, it, itv, flag ] = subspace_iter_v3( Sigma2, m,p,percentage,eps, maxit )
...
for k = 1:n-1
	img = reshape(V(:,k), nb_lignes,nb_colonnes);
...
% Calcul des vecteurs/valeurs propres de la matrice Sigma2 :
[ W, V_2, n_ev, it, itv, flag ] = subspace_iter_v2( Sigma2, m, percentage, p, eps, maxit );
